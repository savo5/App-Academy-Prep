...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
  answer_in_integer = (f_dividend / f_divisor).to_i
  f_dividend / f_divisor - answer_in_integer
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  float_remainder = dec_remainder_of_two_integers(i_dividend, i_divisor)
  int_remainder = (float_remainder * i_divisor).to_i
end
